...
PizzaTopping = Enum(
    "PizzaTopping",
    "mozzarella double_mozzarella bacon mushrooms ham onion oregano")
...
class CreamyBaconBuilder:
    ...
    def add_topping(self):
        print(f"Adding topping to the {self.pizza.name}")
        self.pizza.topping.append([
            i for i in (PizzaTopping.mozzarella, PizzaTopping.bacon,
...
class Waiter:
    ...
    def contruct_pizza(self, builder):
        ...
        [
            step() for step in (builder.prepare_dough, builder.add_source,
...
def validate_style(builders):
    ...
    try:
        ...
        print(
            "hey, fucker, we have only two options, [m]argarita and [c]reamyBacon."
        )
